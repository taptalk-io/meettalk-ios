Pod::Spec.new do |s|
  ...
  # ―――  Spec Metadata  ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
    ...
    s.name         = "MeetTalk"
    s.version      = "0.0.1"
    s.summary      = "MeetTalk iOS SDK is an extension of TapTalk.io SDK, providing complete in-app chat SDK and messaging API, with the addition of voice and video call feature. MeetTalk provides UI-based and code-based implementation & fully customizable."
